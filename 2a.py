# PARTE 2A - Alertas em tempo real nos workers, SEM lock na verificação/zeragem
...
# Locks individuais (mantidos da 1C, mas NÃO usados na verificação/zeragem nesta versão)
locks = {
    "icmp_origem": Lock(),
    "icmp_destino": Lock(),
    "syn_origem": Lock(),
...
def worker(worker_id, fila):
    while True:
        ...
        if IDS.TIPO["icmp"] in pacote:
            # SEM lock na verificação e zeragem (condição de corrida)
            ...
            if total > LIMITE_ICMP:
                ...
                contadores["icmp_origem"][ip_origem] = 0  # zeragem SEM lock
            ...
            if total > LIMITE_ICMP:
                ...
                contadores["icmp_destino"][ip_destino] = 0  # zeragem SEM lock
        ...
        if IDS.TIPO["tcp"] in pacote:
            ...
            if str(tcp.flags) == "S":
                ...
                if total > LIMITE_SYN:
                    ...
                    contadores["syn_origem"][ip_origem] = 0  # zeragem SEM lock
                ...
                if total > LIMITE_SYN:
                    ...
                    contadores["syn_destino"][ip_destino] = 0  # zeragem SEM lock
...
if __name__ == "__main__":
    ...
    # gera_alertas_finais() -- REMOVIDO: alertas agora são gerados pelos workers
    print("fim")